...
{group:"FINANCEIRO",items:[{label:"MOVIMENTAÇÕES",to:"/fluxo",icon:ArrowLeftRight},{label:"ORÇAMENTO",to:"/orcamento",icon:Wallet},{label:"CARTÕES E FATURAS",to:"/faturas",icon:CreditCard},{label:"CUSTOS FIXOS E ASSINATURAS",to:"/custos-fixos",icon:Repeat},{label:"PARCELAS",to:"/parcelados",icon:CreditCard},{label:"INVESTIMENTOS",to:"/investimentos",icon:TrendingUp}]},
{group:"SISTEMA",items:[{label:"CONFIGURAÇÕES",to:"/configuracoes",icon:Settings}]}];
