...
const moduleGroups: ModuleGroup[] = [
  { label: "PRINCIPAL", icon: Wallet, items: [{ label: "INÍCIO", to: "/", icon: Wallet }, { label: "FLUXO", to: "/fluxo", icon: ArrowLeftRight }] },
  ...
  { label: "SISTEMA", icon: Settings, items: [{ label: "AJUSTES", to: "/ajustes", icon: Settings }] },
];
