    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <div className="w-full max-w-sm space-y-5 text-center">
          ...
          <button type="button" onClick={goToApp} className="gradient-primary inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl px-4 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90">ENTRAR NO HUB <ArrowRight className="h-4 w-4" /></button>
        </div>
      </div>
    );
  }
