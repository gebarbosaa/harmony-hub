...
// Despesa no cartao de credito so entra nas somas depois que a fatura for marcada como paga.
const counts = (t: Tx) => t.type !== "DESPESA" || !t.card_name || t.paid;
...
function FluxoPage() {
  ...
  const net = visible.reduce((s, t) => s + (counts(t) ? Number(t.amount) * amountSign(t.type) : 0), 0);
