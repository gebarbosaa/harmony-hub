...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 48 48" className="h-5 w-5">
      ...
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 5.6-4.2 5.6l6.6 5.6C41.4 35.9 44 30.4 44 24c0-1.3-.1-2.7-.4-3.5z" />
    </svg>
  );
}
      ...
      <div className="w-full max-w-sm space-y-8 text-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Gestão financeira pessoal em um só lugar.</p>
          </div>
        </div>
        ...
        <p className="text-xs text-muted-foreground">Ao continuar, você concorda em compartilhar seu perfil básico do Google para uso no Harmony Hub.</p>
      </div>
    </div>
  );
}
